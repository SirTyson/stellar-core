...
class Herder
{
  public:
    ...
    // gate so candidate leaders can propose without re-fetching or
    // re-validating the mempool (docs/direct-leader-flooding.md).
    virtual TxProposalBuilder& getTxProposalBuilder() = 0;
