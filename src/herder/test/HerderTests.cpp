...
testTxSetWithFeeBumps(uint32 protocolVersion)
{
    ...
    SECTION("invalid transaction")
    {
                ...
                "operation, third insufficient")
        {
            ...
            {
                TxFrameList invalidTxs;
                auto txSet = makeTxSetFromTransactions({fb1, fb2, fb3}, *app, ApplyTimeOffset{}, invalidTxs);
                ...
                "exceed balance")
        {
            ...
            SECTION("build block")
            {
                auto txSet = makeTxSetFromTransactions({fb1, fb2}, *app, ApplyTimeOffset{},
                                                       invalidTxs);
                compareTxs(invalidTxs, {fb2});
            }
            SECTION("validate block")
                ...
                "combined exceed balance")
        {
            ...
            SECTION("build block")
            {
                auto txSet = makeTxSetFromTransactions({{}, {fb1, fb2}}, *app, ApplyTimeOffset{}, invalidPerPhase);
